...
import com.ulicae.cinelog.databinding.ActivityMainV3Binding;
 ...
 */
public class V3MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainV3Binding.inflate(getLayoutInflater());
    ...
    public void onBackPressed() {
        if (binding.drawerLayoutV3.isDrawerOpen(GravityCompat.START)) {
            binding.drawerLayoutV3.closeDrawer(GravityCompat.START);
        } else {
            super.onBackPressed();
        }
    }
    ...
    private void initNavigation() {
        setSupportActionBar(binding.toolbarNewV3.toolbar);
        binding.toolbarNewV3.toolbar.setSubtitle(R.string.app_name);


        NavHostFragment navHostFragment = (NavHostFragment) getSupportFragmentManager().findFragmentById(R.id.nav_host_fragment_v3);
        ...
        appBarConfiguration = new AppBarConfiguration.Builder(topLevelDestinations)
                .setOpenableLayout(binding.drawerLayoutV3)
                .build();
        ...
        NavigationUI.setupWithNavController(binding.navViewV3, navController);

        listenDrawerOpenal();
    }

    private void listenDrawerOpenal() {
        binding.drawerLayoutV3.addDrawerListener(new DrawerLayout.DrawerListener() {
            @Override
    ...
    public boolean onSupportNavigateUp() {
        return NavigationUI.navigateUp(navController, binding.drawerLayoutV3);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        /* TODO if (item.getItemId() == R.id.action_export) {
            goToExport();
            return true;
            ...
            binding.drawerLayoutV3.openDrawer(GravityCompat.START);
            return true;
        }*/
    ...
    public FloatingActionButton getFab() {
        return binding.fabV3;
    }

    public SearchView getSearchView() {
        return binding.toolbarNewV3.searchBar;
    }
