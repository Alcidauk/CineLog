 ...
 */
public class ReviewTmdbCrossRefFromDtoCreator extends EntityFromDtoCreator<ReviewTmdbCrossRef, ReviewTmdbCrossRefDao> {
    ...
    public ReviewTmdbCrossRef createRoomInstanceFromDto(KinoDto kinoDto) {
        return kinoDto.getTmdbKinoId() != null ?
                new ReviewTmdbCrossRef(Math.toIntExact(kinoDto.getKinoId()),
