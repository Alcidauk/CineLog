 ...
 */
class WishlistListRoomAdapter extends ArrayAdapter<WishlistDataDto> {

    WishlistListRoomAdapter(@NonNull Context context, @NonNull List<WishlistDataDto> objects) {
