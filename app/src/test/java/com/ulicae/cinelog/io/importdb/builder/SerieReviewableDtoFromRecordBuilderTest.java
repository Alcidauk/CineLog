...
public class SerieReviewableDtoFromRecordBuilderTest {
    ...
    public void build() throws Exception {
        ...
        assertEquals(
                kinoDto,
                new SerieReviewableDtoFromRecordBuilder(preferencesWrapper, context).build(csvRecord)
        );
    }
    ...
    public void build_missingTags() throws Exception {
        ...
        SerieDto kinoDto = new SerieDto(
                ...
                "date release",
                null,
                new ArrayList<>() // TODO implements episode csv build
        );
